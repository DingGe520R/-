...
<body>
<div class="container">
    <h3 style="text-align: center; font-size: 30px;margin-bottom: 20px">图书信息列表</h3>
    ...
    <form id="form" action="${pageContext.request.contextPath}/delSelectBookServlet" method="post">
        <table border="1" class="table table-bordered table-hover">
            ...
            <c:forEach items="${pb.list}" var="book" varStatus="s">
                <tr>
                    ...
                    <td>${book.book_picture}</td>
                    <td>${book.book_type}</td>
                    <td>
                        <a class="btn btn-default btn-sm" href="${pageContext.request.contextPath}/findBookServlet?id=${book.id}">修改</a>&nbsp;
                        <a class="btn btn-default btn-sm" href="javascript:deleteUser(${book.id});">删除</a>
                    </td>
                </tr>
            </c:forEach>
        </table>
